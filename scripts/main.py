...
# file settings
parser.add_argument('--vocab_dir', type=str, default='../data/clevr/clevr_qa', help='dir of qa pairs')
parser.add_argument('--qa_dir', type=str, default='../data/clevr/clevr_qa/parsed_tree/', help='dir of qa pairs')
...
# parser.add_argument('--resume', type=str, default='prelogs/clevr_kaiminginit_modClassifier_ResCNN_DPResOnly1BiLinear_res101_noShare_biLSTMword_AdvFCshift_d.0_resumeE6/model_epoch_7.pth', help='resume file name')
